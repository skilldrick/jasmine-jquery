  ...
  namespace.events = {
    spyOn: function(selector, eventName) {
      var handler = function(e) {
        data.spiedEvents[[selector, eventName]] = jasmine.util.argsToArray(arguments);
      };
...
beforeEach(function() {
  ...
  this.addMatchers({
    ...
    toHaveBeenTriggeredOnAndWith: function(selector, arg) {
      ...
      this.message = function () {
        return [
          "Expected event " + this.actual + " to have been triggered on " + jasmine.pp(selector) + " with argument " + jasmine.pp(expectedArg),
          "Expected event " + this.actual + " not to have been triggered on " + jasmine.pp(selector) + " with argument " + jasmine.pp(expectedArg)
        ];
      };
